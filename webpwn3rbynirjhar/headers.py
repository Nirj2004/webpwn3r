#!/usr/bin/env python
# WebPwn3r is a Web Application Security Scanner
# By Nirjhar Biswas - instagram.com/Nirjhar Biswas
# First demo conducted 31May-2021 @OWASP Chapter Egypt
...
def headers-readers(url):
        ...
        if opener.code == 404:
                ...
                exit()
        #Host = opener.headers.get(HTTPS_HEADERS.HOST)
        Server = opener.headers.get(HTTPS_HEADERS.SERVER)
